...
const Input = styled.input`
  ...
  *:root:has(&[name="theme"][value="light"]:checked) {
  ...
  *:root:has(&[name="theme"][value="system"]:checked) {
    color-scheme: normal;
  }
`;
